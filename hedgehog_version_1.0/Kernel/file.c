...
static int hedgehog_do_open(const char __user *pathname, int flags, umode_t mode)
{
...
static int hedgehog_do_read(unsigned int fd, char __user *buf, size_t size)
{
...
static int hedgehog_do_write(unsigned int fd, char __user *buf, size_t size)
{
...
static long hedgehog_do_truncate(const char __user *path, long length)
{
